...
|------|--------|------|-------|-------------|
| [pair-matching-game](pair-matching-game.md) | Specified | 2026-09-01 | alexander.trakhimenok@gmail.com | pair-matching-rules, pair-matching-sessions, telegram-pair-matching-bot |
