...
|---------|--------|-------------|
| [Telegram Pair-Matching bot (Solo, vs Bot, vs Humans)](telegram-pair-matching-bot/README.md) | Stable | Play **Pair-Matching** (a memory/concentration game) inside Telegram through SneatBot's `/games`. |
